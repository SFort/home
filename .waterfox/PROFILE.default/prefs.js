...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 2108764604);
...
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1608766544);
...
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 2108701687);
...
user_pref("browser.bookmarks.editDialog.confirmationHintShowCount", 106);
...
user_pref("devtools.netmonitor.columnsData", "[{\"name\":\"status\",\"minWidth\":30,\"width\":6.78},{\"name\":\"method\",\"minWidth\":30,\"width\":6.78},{\"name\":\"domain\",\"minWidth\":30,\"width\":15.42},{\"name\":\"file\",\"minWidth\":30,\"width\":34.03},{\"name\":\"cause\",\"minWidth\":30,\"width\":13.34},{\"name\":\"type\",\"minWidth\":30,\"width\":6.79},{\"name\":\"transferred\",\"minWidth\":30,\"width\":13.59},{\"name\":\"contentSize\",\"minWidth\":30,\"width\":4.94},{\"name\":\"waterfall\",\"minWidth\":150,\"width\":3.51},{\"name\":\"initiator\",\"minWidth\":30,\"width\":8.15}]");
...
user_pref("extensions.lastAppBuildId", "20201216043445");
...
user_pref("idle.lastDailyNotification", 1608706787);
...
user_pref("places.database.lastMaintenance", 1608416601);
...
user_pref("security.remote_settings.crlite_filters.checked", 1608765343);
user_pref("security.remote_settings.intermediates.checked", 1608765343);
...
user_pref("services.blocklist.pinning.checked", 1608765343);
user_pref("services.blocklist.pinning.enabled", false);
user_pref("services.settings.clock_skew_seconds", -213);
user_pref("services.settings.last_etag", "\"1608753521920\"");
user_pref("services.settings.last_update_seconds", 1608766756);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1608765343);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1608765343);
user_pref("services.settings.main.hijack-blocklists.last_check", 1608765343);
user_pref("services.settings.main.language-dictionaries.last_check", 1608765343);
user_pref("services.settings.main.public-suffix-list.last_check", 1608765343);
user_pref("services.settings.main.search-config.last_check", 1608765343);
user_pref("services.settings.main.search-default-override-allowlist.last_check", 1608765343);
user_pref("services.settings.main.sites-classification.last_check", 1608765343);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1608765343);
user_pref("services.settings.security.onecrl.checked", 1608765343);
...
user_pref("storage.vacuum.last.places.sqlite", 1608220060);
user_pref("svg.disabled", true);
user_pref("toolkit.startup.last_success", 1608765193);
